...
$GLOBALS['theme_base'] = theme_base_path();
$twig->addGlobal('theme_base', $GLOBALS['theme_base']);
$twig->addExtension(new CustomTwigExtensions($translator, theme_base_path()));

$context = [];
$url = theme_request_path();
...
elseif ($url == '/testimonials') {
    $context = testimonialsAll();
    echo $twig->render('testimonials/index.twig', $context);
}
